...
_TEAM_BASE_DATA: Dict[str, Dict] = {
    ...
    "Turkey":     {"avg_scored": 1.2, "avg_conceded": 1.3, "matches": 16, "elo": 71},
    # 中下游（25-40）
    ...
    # 首秀/弱旅
    "South Africa":  {"avg_scored": 0.9, "avg_conceded": 1.6, "matches": 7,  "elo": 60},
    "Czech Republic":{"avg_scored": 1.1, "avg_conceded": 1.4, "matches": 9,  "elo": 66},
    "Bosnia and Herzegovina":{"avg_scored": 1.0, "avg_conceded": 1.5, "matches": 6,  "elo": 63},
    "Qatar":         {"avg_scored": 0.7, "avg_conceded": 2.0, "matches": 3,  "elo": 55},
    "Haiti":         {"avg_scored": 0.7, "avg_conceded": 1.8, "matches": 0,  "elo": 50},
    "Scotland":      {"avg_scored": 1.0, "avg_conceded": 1.5, "matches": 8,  "elo": 64},
    "Paraguay":      {"avg_scored": 1.0, "avg_conceded": 1.4, "matches": 8,  "elo": 65},
    "Curaçao":       {"avg_scored": 0.6, "avg_conceded": 2.0, "matches": 0,  "elo": 48},
    "Ivory Coast":   {"avg_scored": 1.1, "avg_conceded": 1.3, "matches": 9,  "elo": 67},
    "Côte d'Ivoire": {"avg_scored": 1.1, "avg_conceded": 1.3, "matches": 9,  "elo": 67},
    "Sweden":        {"avg_scored": 1.3, "avg_conceded": 1.2, "matches": 20, "elo": 74},
    "Tunisia":       {"avg_scored": 0.9, "avg_conceded": 1.5, "matches": 10, "elo": 62},
    "Egypt":         {"avg_scored": 1.1, "avg_conceded": 1.4, "matches": 7,  "elo": 65},
    "New Zealand":   {"avg_scored": 0.8, "avg_conceded": 1.7, "matches": 4,  "elo": 58},
    "Cape Verde":    {"avg_scored": 0.6, "avg_conceded": 2.1, "matches": 0,  "elo": 47},
    "Iraq":          {"avg_scored": 0.8, "avg_conceded": 1.7, "matches": 0,  "elo": 55},
    "Norway":        {"avg_scored": 1.2, "avg_conceded": 1.3, "matches": 10, "elo": 68},
    "Algeria":       {"avg_scored": 1.0, "avg_conceded": 1.4, "matches": 8,  "elo": 65},
    "Austria":       {"avg_scored": 1.1, "avg_conceded": 1.4, "matches": 7,  "elo": 64},
    "Jordan":        {"avg_scored": 0.7, "avg_conceded": 1.9, "matches": 0,  "elo": 52},
    "DR Congo":      {"avg_scored": 0.8, "avg_conceded": 1.8, "matches": 3,  "elo": 55},
    "Uzbekistan":    {"avg_scored": 0.7, "avg_conceded": 1.9, "matches": 0,  "elo": 50},
    "Panama":        {"avg_scored": 0.8, "avg_conceded": 1.7, "matches": 3,  "elo": 56},
}
